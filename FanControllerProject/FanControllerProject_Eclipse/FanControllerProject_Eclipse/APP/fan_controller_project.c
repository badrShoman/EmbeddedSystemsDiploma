...
#include "../MCAL/adc.h"							/* Initialize ADC */
#include "../HAL/dc_motor.h"						/* Use DC motor*/
#include "../HAL/lcd.h"								/* Use LCD */
#include "../HAL/lm35_three_terminal_sensor.h"		/* Use sensor */
#include "../MCAL/timer.h"							/* Initialize timers */
